...
import company.vk.edu.distrib.compute.borodinavalera1996dev.kafka.AuditableKVServiceFactory;
...
public class AuditServiceFactoryArgumentsProvider implements ArgumentsProvider {
    private final Set<ImmutablePair<Class<? extends KVServiceFactory>, Class<? extends AuditServiceFactory>>>
            factories = Set.of(
            ImmutablePair.of(AuditableKVServiceFactory.class, AuditServiceFactory.class)
    );
